...
function InterviewPage() {
  ...
  async function handleStart() {
    ...
    try {
      const response = await fetch('https://interview-backend-jscm.onrender.com/api/ai/questions', {
        method: 'POST',
  ...
  async function handleNext() {
    ...
    try {
      const response = await fetch('https://interview-backend-jscm.onrender.com/api/ai/feedback', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
